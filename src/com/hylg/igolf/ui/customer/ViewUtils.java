...
public class ViewUtils {
	...
	public static int getResId(String resName, String defType) {
		try {
			...
			Resources resources = MainApp.getInstance().getPackageManager().getResourcesForApplication(packageName);
...
//		MToast.showMessage(message);
		Toast.makeText(MainApp.getInstance(), message, Toast.LENGTH_SHORT).show();
	}

	public static void showMessage(int messageId) {
//		MToast.showMessage(messageId);
		Toast.makeText(MainApp.getInstance(), messageId, Toast.LENGTH_SHORT).show();
	}
