...
public class CustomerHomeFrgNew extends Fragment implements View.OnClickListener,
...
//		Bundle args = getArguments();cusinfo_logout
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View head  = inflater.inflate(R.layout.customer_info_head, container, false);
		
		
		View view = inflater.inflate(R.layout.customer_frg_home_new, null);
		...
		view.findViewById(R.id.customer_home_head_message_image).setOnClickListener(this);
		
		moreImage = (ImageView) view.findViewById(R.id.customer_home_head_more_image);
		moreImage.setOnClickListener(this);
		nickName = (TextView) view.findViewById(R.id.customer_home_head_nick_text);
		...
		mList = (ListviewBottomRefresh) view.findViewById(R.id.customer_friend_message_listview);
        ...
        mMainMenuPop.setBackgroundDrawable(getActivity().getResources().getDrawable(R.drawable.bg_gray));  
...
//			loadFail.displayFail("加载失败！");
	...
	private void initDataAysnc() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		Loader1 = new GetCustomerFriendHotListLoader(getActivity(),sn,sn, startPage,pageSize, 
	...
	private void initListView(ArrayList<FriendHotItem> inviteList) {
		...
		mFriendHotAdapter = new FriendCircleAdapter(getActivity(), inviteList,mList, null,true);
...
//		} else {
	...
	private void loadMoreData() {
		...
		/*sn 暂时等于1*/
		Loader1 = new GetCustomerFriendHotListLoader(getActivity(), sn, sn,startPage, pageSize, new GetCustomerFriendHotListCallback() {
	...
	public void onClick(View v) {
		...
		switch(v.getId()) {
			...
			case R.id.cusinfo_expand_btn:
				ModifySignatureActivity.startModifySignatureActivity(CustomerHomeFrgNew.this, customer.signature);
				getActivity().overridePendingTransition(R.anim.ac_slide_right_in, R.anim.ac_slide_left_out);
				break;
			case R.id.customer_album_add:
				ImageSelectActivity.startImageSelect(CustomerHomeFrgNew.this);
				break;
