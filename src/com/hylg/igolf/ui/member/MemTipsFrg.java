...
public class MemTipsFrg extends Fragment {
...
//			loadFail.displayFail("加载失败！");
	...
	private void initDataAysnc() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetCustomerFriendHotListLoader(getActivity(),sn, mem_sn,startPage,pageSize,
	...
	private void refreshData() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetCustomerFriendHotListLoader(getActivity(),sn,mem_sn, 1, startPage*pageSize,
			new GetCustomerFriendHotListCallback() {
	...
	private void initListView(ArrayList<FriendHotItem> inviteList) {
		...
		mFriendHotAdapter.setIsAvatarClickable(false);
