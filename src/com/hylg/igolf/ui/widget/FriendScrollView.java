...
import com.hylg.igolf.ui.friend.FriendTipsDetailActivity;
 ...
 */
public class FriendScrollView extends ScrollView {

    public static final String TAG = "ProfileScrollView";

    public FriendScrollView(Context context) {
        super(context);
    }

    public FriendScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FriendScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private FriendTipsDetailActivity mContext;

    @Override
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        super.onLayout(changed, l, t, r, b);

        mContext = (FriendTipsDetailActivity)getContext();
    }
...
//                Logger.e(TAG, "Got ACTION_MOVE event but don't have an active pointer id.");
            ...
            if (yDiff < 0) {
                ...
                if (mContext.commentListLinear.getVisibility() == View.VISIBLE && mContext.commentsList.firstItemIndex > 0){

                    return false;
                }

                if (mContext.praiseListLinear.getVisibility() == View.VISIBLE && mContext.praiserList.firstItemIndex > 0){
