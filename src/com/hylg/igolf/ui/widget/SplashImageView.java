...
public class SplashImageView extends ImageView {
        ...
        private SplashTransitionGenerator mTransGen = new SplashTransitionGenerator(2000,new AccelerateInterpolator());
...
//                        mMatrix.postTranslate(0.8f, 0.5f);
//                       mMatrix.postScale(1.1f, 1.1f);
//                        mMatrix.postTranslate(0.8f, 0.8f);
...
//                            DebugTools.getDebug().debug_v("postTranslate1", "------>>>1>>" + (-mDrawableRect.width() / 2));
//                            DebugTools.getDebug().debug_v("postTranslate1", "------>>>2>>" + (-mDrawableRect.height() / 2));
//                            DebugTools.getDebug().debug_v("totalScale", "------>>>totalScale>>" + totalScale);
//                            DebugTools.getDebug().debug_v("postTranslate2", "------>>>translX>>" + translX);
//                            DebugTools.getDebug().debug_v("postTranslate2", "------>>>translY>>" + translY);
         ...
         */
        public void setTransitionGenerator(SplashTransitionGenerator transgen) {
            mTransGen = transgen;
            startNewTransition();
        }
