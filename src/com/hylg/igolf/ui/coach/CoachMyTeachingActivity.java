...
public class CoachMyTeachingActivity extends FragmentActivity implements onResultCallback {
	
	private static final String 					TAG = "CoachMyTeachingActivity";
	...
	public static void startCoachMyTeachingActivity (Context context) {

		Intent data = new Intent(context,CoachMyTeachingActivity.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hall_frg_my_teaching);
	...
	public void initUI () {
		...
		mBack = (ImageButton) findViewById(R.id.coach_my_teaching_back);
		mBack.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {

				MainActivity.startMainActivity(CoachMyTeachingActivity.this);
				CoachMyTeachingActivity.this.finish();

			}
		});
		listView = (EhecdListview) findViewById(R.id.hall_my_teaching_listview);
...
//	}
	...
	private void initDataAysnc() {
		...
		startPage = 1;
		reqLoader = new GetMyTeachingListLoader(this, customer.id, startPage, pageSize, new GetMyTeachingListCallback() {
			@Override
			public void callBack(int retId, String msg, ArrayList<CoachInviteOrderDetail> inviteList) {
				...
				if(BaseRequest.REQ_RET_F_NO_DATA == retId || inviteList.size() == 0) {
					...
					Toast.makeText(CoachMyTeachingActivity.this, msg, Toast.LENGTH_SHORT).show();
	...
	private void refreshDataAysnc(int startPage) {
		...
		clearLoader();
		findViewById(R.id.hall_my_teaching_progress).setVisibility(View.VISIBLE);
		reqLoader = new GetMyTeachingListLoader(this, customer.id, startPage, pageSize, new GetMyTeachingListCallback() {
			@Override
			public void callBack(int retId, String msg, ArrayList<CoachInviteOrderDetail> inviteList) {

				findViewById(R.id.hall_my_teaching_progress).setVisibility(View.GONE);
...
//			}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			ViewHolder holder;
			if(null == convertView) {
				convertView = View.inflate(CoachMyTeachingActivity.this, R.layout.invite_list_mime_item, null);
...
//			}
			...
			if (data.teacher_sn.equalsIgnoreCase(customer.sn)) {
				...
				loadAvatar(CoachMyTeachingActivity.this, data.student_sn, data.student_avatar, holder.avatar, true,
				...
				loadAvatar(CoachMyTeachingActivity.this, data.teacher_sn, data.teacher_avatar, holder.avatar, true,
						(int) getResources().getDimension(R.dimen.avatar_detail_size));
...
//				if (status == Const.MY_TEACHING_REFUSE) {
//
//					CoachInviteAgainActivity.startCoachInviteAgainActivity(CoachMyTeachingActivity.this,list.get(position));
//
//				} else {

					CoachInviteOrderDetailActivity.startCoachInviteOrderDetailActivity(CoachMyTeachingActivity.this, list.get(position));
//				}


				CoachMyTeachingActivity.this.overridePendingTransition(R.anim.ac_slide_right_in, R.anim.ac_slide_left_out);
			}
		}
