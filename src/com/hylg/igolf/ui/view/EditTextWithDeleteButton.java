...
public class EditTextWithDeleteButton extends LinearLayout {	
	...
	private final String TAG = "EditTextWithDeleteButton";
	...
	private void initViews(Context context, AttributeSet attrs) {
		...
		try {
			...
			deleteButtonRes = a.getResourceId(
					...
					R.drawable.search_box_cancel);
			
			textSize = (int)a.getDimension(R.styleable.EditTextWithDeleteButton_textSize,12);
			
			DebugTools.getDebug().debug_v(TAG, "textSize>>>>>>>>>."+textSize);
	...
	@SuppressLint("NewApi")
	private EditText createEditText(Context context, String hintText,int textSize) {
