...
public class ShareMenuRank implements OnClickListener {
	...
	String 									content = "从爱高尔夫分享,我的排名";

	public ShareMenuRank(Activity context, View view,String location,int sex) {
