...
public class FriendAttentionFrg extends Fragment {
	
	private final String              TAG                          = "FriendAttentionFrg";
...
//			loadFail.displayFail("加载失败！");
	...
	private void initDataAysnc() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetFriendHotListLoader(getActivity(),sn, startPage,pageSize, "",Config.FRIEND_ATTENTION,
	...
	private void refreshData() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetFriendHotListLoader(getActivity(),sn, 1, startPage*pageSize, "",Config.FRIEND_ATTENTION,
			new GetFriendHotListCallback() {
