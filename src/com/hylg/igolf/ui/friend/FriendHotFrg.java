...
//			
//			mFriendMessageNewItem = (FriendHotItem)data.getSerializable("Message");
//			
...
//		}
	...
	private void initDataAysnc() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetFriendHotListLoader(getActivity(),sn, startPage,pageSize, "",Config.FRIEND_HOT,
	...
	private void refreshData() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetFriendHotListLoader(getActivity(),sn, 1, startPage*pageSize, "",Config.FRIEND_HOT,
			new GetFriendHotListCallback() {
