...
public class AppSettings {
    ...
    public static int getUnreadInterval() {
        ...
        String[] valueArr = MainApp.getInstance().getResources().getStringArray(R.array.prefValues);
...
//        if (true) return 5;
        ...
        if (index == 3) {
            if (Utils.getNetworkType() == Utils.NetWorkType.wifi)
                count = 100;
        }
        else {
    ...
    public static int getTextSize() {
        ...
        return MainApp.getInstance().getResources().getDimensionPixelSize(txtSizeResArr[value]);
    }
