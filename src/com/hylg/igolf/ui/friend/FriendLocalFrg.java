...
//			loadFail.displayFail("加载失败！");
	...
	private void initDataAysnc() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetFriendHotListLoader(getActivity(),sn, startPage,pageSize, mProvenceStr,Config.FRIEND_LOCAL,
	...
	private void refreshData() {
		...
		clearLoader();
		/*sn 暂时等于1*/
		reqLoader = new GetFriendHotListLoader(getActivity(),sn, 1, startPage*pageSize, mProvenceStr,Config.FRIEND_LOCAL,
			new GetFriendHotListCallback() {
