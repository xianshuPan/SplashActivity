...
public class GetCustomerFriendList extends BaseRequest {
	...
	public GetCustomerFriendList(Context context, String sn, String tosn ,int pageNum, int pageSize) {
		super(context);
		...
		s.append(PARAM_CONN);
		s.append(PARAM_REQ_TOSN); s.append(KV_CONN); s.append(tosn);
		s.append(PARAM_CONN);
	...
	public String getRequestUrl() {
		return getReqParam2("getSelfTipsInfo", param);
	}
