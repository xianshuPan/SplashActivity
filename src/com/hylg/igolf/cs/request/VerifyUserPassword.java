...
public class VerifyUserPassword extends BaseRequest {
	private String param;

	public VerifyUserPassword(Context context, String sn, String password) {
		super(context);
	...
	public String getRequestUrl() {
		return getReqParam("verifyPassword", param);
	}
