...
public class RebindVerifyPhone extends BaseRequest {
	private String param;

	public RebindVerifyPhone(Context context, String sn,String phone, String verifyCode) {
		super(context);
	...
	public String getRequestUrl() {
		return getReqParam("rebindPhoneDo", param);
	}
